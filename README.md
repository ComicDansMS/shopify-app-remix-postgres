## This is a modified Shopify App Template

This is simply an example of using postgres in a Shopify app. It by no means follows best practice. It is just something that works.
...
4. You must create a postgres database and provide the credentials in a .env file in the root of the project (using .env.example as a template)
